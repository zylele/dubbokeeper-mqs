...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/libs/style.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/libs/jquery.prompt.css">
